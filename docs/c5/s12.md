...
=== "中文"
    ...
    **partition** process will happen next. It will find the split point and
    ...
    <div id="quick_anim1" class="">
        ...
        <br>
        <button style="border: 1px solid black; background-color: buttonface; padding: 2px;" onclick="quick_anim1_anim = quick_anim_init('quick_anim1')">Initialize</button>
        <button style="border: 1px solid black; background-color: buttonface; padding: 2px;" onclick="quick_anim1_anim.run('quick_anim1_anim')">Run</button>
        <button style="border: 1px solid black; background-color: buttonface; padding: 2px;" onclick="quick_anim1_anim.stop()">Stop</button> <br>
        <button style="border: 1px solid black; background-color: buttonface; padding: 2px;" onclick="quick_anim1_anim.begin()">Beginning</button>
        <button style="border: 1px solid black; background-color: buttonface; padding: 2px;" onclick="quick_anim1_anim.forward()">Step Forward</button>
        <button style="border: 1px solid black; background-color: buttonface; padding: 2px;" onclick="quick_anim1_anim.backward()">Step Backward</button>
        <button style="border: 1px solid black; background-color: buttonface; padding: 2px;" onclick="quick_anim1_anim.end()">End</button>
        <script>
